...
public class RemoveFromUserInboxRest {
	...
	public static void main(String[] args) {
		...
		Response r = target.path(mid).request().accept(MediaType.APPLICATION_JSON)
				.put(Entity.entity(mid, MediaType.APPLICATION_JSON));

		if (r.getStatus() == Status.OK.getStatusCode()) {
			System.out.println("Success: message with id: " + mid + " removed from " + user + "'s inbox");
