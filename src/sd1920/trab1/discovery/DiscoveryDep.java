 ...
 * </p>
 */
public class DiscoveryDep {
	private static Logger Log = Logger.getLogger(DiscoveryDep.class.getName());
	 ...
	 */
	public DiscoveryDep(InetSocketAddress addr, String serviceName, String serviceURI) {
		this.addr = addr;
	...
	public static void main(String[] args) throws Exception {
		DiscoveryDep discovery = new DiscoveryDep(DISCOVERY_ADDR, "test",
