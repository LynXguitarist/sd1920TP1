...
public interface UserServiceSoap {
	 ...
	 * @return the user object, if the name exists and pwd matches the existing
	 *         password (or is the a special password allowing all operations).
	 * @throws MessagesException in case of error.
	 */
	@WebMethod
	 ...
	 * @return the updated user object, if the name exists and pwd matches the
	 *         existing password (or is the a special password allowing all
	 *         operations); 409 otherwise
	 */
	@WebMethod
	 ...
	 * @param name the name of the user
	 * @param pwd  password of the user (or a special password)
	 * @return the deleted user object, if the name exists and pwd matches the
	 *         existing password (or is the a special password allowing all
	 *         operations).
	 * @throws MessagesException in case of error.
	 */
